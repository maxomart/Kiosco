...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      "Auto-factura en POS (1 clic al cobrar)",
      "NC parcial + ND con monto y concepto",
      "Libro IVA Ventas exportable a Excel",
...
const COMPARISON: { section: string; rows: [string, ...(string | boolean)[]][] }[] = [
  ...
  { section: "Ventas y POS", rows: [
    ...
    ["Auto-factura en POS (al cobrar)", false, false, true],
    ["NC parcial (anular menos del total)", false, false, true],
    ["ND con monto + concepto custom", false, false, true],
    ["Libro IVA Ventas exportable", false, false, true],
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Sí, emitimos factura A, B y C con CAE directo de ARCA según corresponda. Cupos mensuales: 50 en Básico, 2.000 en Profesional. El Profesional además incluye auto-factura desde el POS, NC parciales, ND con monto custom y Libro IVA Ventas exportable.",
  },
  {
...
const PRICING_FAQ_FOR_SCHEMA = [
  ...
  },
  {
    ...
    answer: "Sí, emitimos factura A, B y C con CAE directo de ARCA. Cupos mensuales: 50 en Básico, 2.000 en Profesional. El Pro incluye auto-factura en POS, NC parciales, ND con monto custom y Libro IVA Ventas exportable.",
  },
  {
