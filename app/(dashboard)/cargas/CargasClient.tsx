  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h1 className="text-2xl font-bold text-white">Pedidos a proveedores</h1>
          <p className="text-gray-400 text-sm mt-1">Cada pedido suma automáticamente al stock de tus productos</p>
        </div>
        <div className="flex items-center gap-2">
          <a
            href="/pedidos-proveedor"
            className="flex items-center gap-2 px-3 py-2 rounded-lg bg-purple-600/20 hover:bg-purple-600/30 text-purple-200 border border-purple-700/40 text-sm font-medium transition-colors"
            title="La IA arma una plantilla de pedido por proveedor según lo que se está por agotar"
          >
            <Sparkles size={16} /> Sugerencias IA
          </a>
