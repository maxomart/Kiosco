...
export default async function DashboardLayout({
  ...
  // userRow se usa para decidir si mostrar el tour inicial y el modal de
  // bienvenida por upgrade. (La verificación de email por código quedó
  // desactivada — el acceso al dashboard ya no la exige.)
